...
const buildings: Record<string, LifeformBuildingEntry> = {
  ...
  // v0.0.988 — owner 2026-06-08 __ogamexLfTreeSweep("humans") + parse_humans_tree.py
  // 解析 ogame 真 technologytree, 修正下列 9 项 prereq (含 v0.0.939 owner skyscraper
  // + planetaryShield 误解读). 每条 depth1 = 该 building 自己 tree 的直接 prereq.
  academyOfSciences: {
    id: "academyOfSciences",
    display_name_zh: "科學院",
    display_name_en: "Academy of Sciences",
    requires: { residentialSector: 41 },
  ...
  skyscraper: {
    ...
    requires: { fusionPoweredProduction: 1 },
  ...
  biotechLab: {
    ...
    requires: { fusionPoweredProduction: 2 },
  ...
  metropolis: {
    ...
    requires: { skyscraper: 6, neuroCalibrationCentre: 1 },
    cost_at: pow(80_000, 1.5),
    verified_against_live: true,
  },
  planetaryShield: {
    id: "planetaryShield",
    display_name_zh: "行星護盾",
    display_name_en: "Planetary Shield",
    requires: { fusionPoweredProduction: 5, neuroCalibrationCentre: 5 },
    cost_at: pow(120_000, 1.5),
    verified_against_live: true,
  },
